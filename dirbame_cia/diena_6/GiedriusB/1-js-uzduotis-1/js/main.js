...
function pazymiuVidurkis(){
  ...
  let men4 = 6;
  let men5 = 8;
  console.log((men1 + men2 + men3 + men4 + men5) / 5)
}
pazymiuVidurkis();
// 2.2 UZDUOTIS
...
return console.log(pajamos - nuostoliai);
}
getPelnas1(12000, 7000);
// 4.1 UZDUOTIS
...
console.log(getPazymiuVidurkis2(10, 9, 5, 8, 7));
// 4.2 UZDUOTIS
...
return (getPazymiuVidurkis2(10, 5, 6, 7, 8) + getPazymiuVidurkis2(9, 8, 7, 7, 5)
+ getPazymiuVidurkis2(7, 5, 7, 8, 9) + getPazymiuVidurkis2(5, 10, 9, 8, 7)
  + getPazymiuVidurkis2(8, 9, 7, 8, 6) + getPazymiuVidurkis2(7, 8, 9, 10, 10)) / 6;
}
