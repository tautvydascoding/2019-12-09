                    ...
                    <?php if (isset($_SESSION['admin'])) : ?>
                        ...
                        <div class="control-panel h-100">
                            <div class="control-button trash p-2 mb-3">
                                <form method='post' action='delete_product.php?id=<?php echo $product['id'] ?>'>
                                    ...
                                    <button type='submit' name='delete_file' class="delete" value='Delete File'>
                                        <svg aria-hidden="true" width="30" height="30" focusable="false" data-prefix="fas" data-icon="trash" class="svg-inline--fa fa-trash fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            ...
                            <div class="control-button p-2">
                                <a href="page_edit_product.php?id=<?php echo $product['id'] ?>"><svg aria-hidden="true" width="30" height="30" focusable="false" data-prefix="fas" data-icon="edit" class="svg-inline--fa fa-edit fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                    ...
                                    <div class='row align-items-center'>
                                        ...
                                        <div class='col-3 px-0'>
                                            <form action="page_shoping_cart.php" method="POST">
                                                ...
                                                <button type="submit" class="btn p-0" name="add_to_cart"><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 24 24'>
                                                        <path d='M0 0h24v24H0z' fill='none' />
                                                        <path d='M17.21 9l-4.38-6.56c-.19-.28-.51-.42-.83-.42-.32 0-.64.14-.83.43L6.79 9H2c-.55 0-1 .45-1 1 0 .09.01.18.04.27l2.54 9.27c.23.84 1 1.46 1.92 1.46h13c.92 0 1.69-.62 1.93-1.46l2.54-9.27L23 10c0-.55-.45-1-1-1h-4.79zM9 9l3-4.4L15 9H9zm3 8c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z' /></svg></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
